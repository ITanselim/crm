              ...
              <?php
                  ...
                  if ($leads > 0){
                      foreach ($appointments as $appointment){
                         ...
                         echo "<tr>";
                              echo "<td>".modules::run("dashboard/setindex_Lead_ID",$appointment['project_id'])."</td>"; 
                              echo "<td>".$appointment['m_fname']. ' '. $appointment['m_lname'].  "</td>";
                              echo "<td>".date('H:i:s',strtotime($appointment['appt_schedule']))."</td>";
                              echo "<td>".$appointment['appt_start_time'] . ' '. $appointment['appt_end_time']."</td>";
                              echo "<td>".$appointment['appt_status']."</td>";
                              echo "<td>$ ".$appointment['appt_date_create']."</td>";


                              // echo "<td><button type='button' class='btn btn-outline-info btn-sm viewleadremark_history1' data-toggle='modal' data-target='#viewleadremarkhistorymodal' data-backdrop='static' data-keyboard='false' data-author_name='".$appointment['author_name']."' data-project_id='".$appointment['project_id']."'>View</a></td>";
                          echo "</tr>";
                     }
                  }  
                  ?>
