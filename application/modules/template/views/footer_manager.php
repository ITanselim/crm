...
<!-- The History Leas  Remark-->
     ...
     <script>var session_user_id = "<?php echo $this->session->userdata['userlogin']['user_id'] ?>";</script>

     <script>var modular = "<?php echo modules::run('dashbard/lead_remark, ""'); ?>";</script>
...
<script type="text/javascript">
 ...
 $('#leaddataTableagents').DataTable({"sPaginationType": "listbox"});
