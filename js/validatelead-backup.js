                ...
                var get_installment_term ='';
                  ...
                  success:function(res){
                      ...
                      if(count > 1){
                           ...
                           $("#update_lead_form input[name='product_name']").prop('readonly', true);
                           ...
                           $("#update_lead_form input[name='amount_paid']").prop('readonly', true);
                ...
                var display_action_approval='';
                  ...
                  success:function(res){
                      ...
                      if(usertype == 'Agent'){
                        ...
                        $('#collectionagentdataTable').DataTable();
      ...
      $(document).on('click','#viewleadhistorymodal .viewleadremark_history',function(e) {
            ...
            dataEdit = 'author_name='+ author_name;
            var tr= '';
                  $.ajax({
                  type:'GET',
                  data:dataEdit,
                  url: base_url +'dashboard/view_lead_history/'+ author_name,
                  dataType: 'json',
                  success:function(data){
                      for (var i = 0; i < data.length; i++) {
                        tr += '<tr>'+
                        ...
                        $(".viewleadremarkhistory td").filter(function() {
                            ...
                            $('#historyremarkleadtable').DataTable();
      ...
      $(document).on('click','#leaddataTable .view_lead_assign_manager, #leaddataTable .view_manager_assign',function(e) {
      ...
      $(document).on('click','#leaddataTable .view_lead_assign_agent',function(e) {
                  ...
                  success:function(data){
                      for (var i = 0; i < data.length; i++) {
                        ...
                        $('#viewreport_designermodal .viewreportdesignerhistory').html(tr);
                         ...
                         $('#historydesignertable').DataTable();
      ...
      $(document).on('click','#leaddataTable .view_report_author',function(e) {
            var project_id= $(this).data('project_id');
            ...
            $("#updatereportform :input").attr("disabled", false);
                  ...
                  success:function(data){
                      ...
                      for (var i = 0; i < back_cover.length; i++) {
                       ...
                       $('#updatereportModal .front_cover_report_detail').html(tr_front_cover_designer);
                       $('#updatereportModal .back_cover_report_detail').html(tr_back_cover_designer);
            ...
            var tr= '';
                  ...
                  success:function(data){
                      for (var i = 0; i < data.length; i++) {
                        ...
                        $('#approvalhistoryDatatable').DataTable();
            ...
            var tr= '';
                  ...
                  success:function(data){
                      for (var i = 0; i < data.length; i++) {
                        ...
                        $('#confirmationpaymenthistory').DataTable();
      ...
      $('body').delegate('#updatereportform #remove','click', function(){
             var report_id= $(this).data('report_id');
             var project_id= $(this).data('project_id');
             var access= $(this).data('access');

            dataEdit = 'report_id='+report_id+'&project_id='+project_id+'&access='+access;
                  $.ajax({
                  type:'GET',
                  data:dataEdit,
                  ...
                  success: function(res) {
                      if (res.response=="success"){
                           $('#updatereportform #remove').attr('data-access', 0);
                      }
                       else{
              ...
              var count= $('#updatereportform table').find('.author_report_detail').children().length;
                if (count!=1){
                  $(this).closest ('tr').remove();
             }
      ...
      $(document).on('click','#file_form #add_file',function(e) {
          $('#leaddataTablefixed').DataTable().ajax.reload( null, true);
          $.ajax({
      ...
      $(document).on('click','.file_details .view_filehistory',function(e) {
        e.preventDefault();
            ...
            var tr= '';
                  ...
                  type:'GET',
                  data:dataEdit,
                  url: base_url +'dataashboard/view_file_remark/',
                  dataType: 'json',
                  success:function(data){
                      for (var i = 0; i < data.length; i++) {
                        tr += '<tr>'+
                                  '<td>'+data[i].from_user+'</td>'+
                                  '<td>'+data[i].date_commentnt+'</td>'+
